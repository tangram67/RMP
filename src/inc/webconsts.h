...
STATIC_CONST size_t SESSION_ID_SIZE = strlen(SESSION_ID);
STATIC_CONST size_t SESSION_REMOTE_HOST_SIZE = strlen(SESSION_REMOTE_HOST);
STATIC_CONST size_t SESSION_USER_NAME_SIZE = strlen(SESSION_USER_NAME);
STATIC_CONST size_t SESSION_USER_PASSWORD_SIZE = strlen(SESSION_USER_PASSWORD);
...
STATIC_CONST size_t MULTIPART_FORM_DATA_SIZE = strlen(MULTIPART_FORM_DATA);
STATIC_CONST char ENCODING_FORM_URLENCODED[] = MHD_HTTP_POST_ENCODING_FORM_URLENCODED;
STATIC_CONST size_t ENCODING_FORM_URLENCODED_SIZE = strlen(ENCODING_FORM_URLENCODED);

STATIC_CONST char XML_HTTP_REQUEST[] = "XMLHttpRequest";
STATIC_CONST size_t XML_HTTP_REQUEST_SIZE = strlen(XML_HTTP_REQUEST);
STATIC_CONST char XML_HTTP_REQUEST_HEADER[] = "X-Requested-With";
STATIC_CONST size_t XML_HTTP_REQUEST_HEADER_SIZE = strlen(XML_HTTP_REQUEST_HEADER);

STATIC_CONST char UPGRADE_HTTP_REQUEST[] = "upgrade";
STATIC_CONST size_t UPGRADE_HTTP_REQUEST_SIZE = strlen(UPGRADE_HTTP_REQUEST);

STATIC_CONST char UPGRADE_HTTP_PROTOCOL[] = "websocket";
STATIC_CONST size_t UPGRADE_HTTP_PROTOCOL_SIZE = strlen(UPGRADE_HTTP_PROTOCOL);

STATIC_CONST char HTTP_WEB_SOCKET_GUID[] = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
STATIC_CONST size_t HTTP_WEB_SOCKET_GUID_SIZE = strlen(HTTP_WEB_SOCKET_GUID);


STATIC_CONST char HTTP_WEB_SOCKET_KEY[] = "Sec-WebSocket-Key";
STATIC_CONST size_t HTTP_WEB_SOCKET_KEY_SIZE = strlen(HTTP_WEB_SOCKET_KEY);

STATIC_CONST char HTTP_WEB_SOCKET_ACCEPT[] = "Sec-WebSocket-Accept";
STATIC_CONST size_t HTTP_WEB_SOCKET_ACCEPT_SIZE = strlen(HTTP_WEB_SOCKET_ACCEPT);

STATIC_CONST char HTTP_WEB_SOCKET_PROTOCOL[] = "Sec-WebSocket-Protocol";
STATIC_CONST size_t HTTP_WEB_SOCKET_PROTOCOL_SIZE = strlen(HTTP_WEB_SOCKET_PROTOCOL);

STATIC_CONST char HTTP_WEB_SOCKET_VERSION[] = "Sec-WebSocket-Version";
STATIC_CONST size_t HTTP_WEB_SOCKET_VERSION_SIZE = strlen(HTTP_WEB_SOCKET_VERSION);
