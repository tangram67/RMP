...
/* Name of package */
#define MHD_BUILD_PACKAGE "libmicrohttpd"

/* Define to the address where bug reports for this package should be sent. */
#define MHD_BUILD_PACKAGE_BUGREPORT "libmicrohttpd@gnu.org"

/* Define to the full name of this package. */
#define MHD_BUILD_PACKAGE_NAME "GNU Libmicrohttpd"

/* Define to the full name and version of this package. */
#define MHD_BUILD_PACKAGE_STRING "GNU Libmicrohttpd 0.9.69"

/* Define to the one symbol short name of this package. */
#define MHD_BUILD_PACKAGE_TARNAME "libmicrohttpd"

/* Define to the home page for this package. */
#define MHD_BUILD_PACKAGE_URL "http://www.gnu.org/software/libmicrohttpd/"

/* Define to the version of this package. */
#define MHD_BUILD_PACKAGE_VERSION "0.9.69"
...
#define MHD_BUILD_VERSION "0.9.69"
