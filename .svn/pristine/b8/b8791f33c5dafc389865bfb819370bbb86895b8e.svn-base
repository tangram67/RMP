...
enum 
{
    ...
    kALAC_ParamError_0         = -50,

    // Decoder error
    kALAC_ParamError_51        = -51,
    kALAC_ParamError_52        = -52,
    kALAC_ParamError_53        = -53,
    kALAC_ParamError_54        = -54,
    kALAC_ParamError_55        = -55,
    kALAC_ParamError_56        = -56,
    kALAC_ParamError_57        = -57,
    kALAC_ParamError_58        = -58,
    kALAC_ParamError_59        = -59,
    kALAC_ParamError_60        = -60,
    kALAC_ParamError_61        = -61,
    kALAC_ParamError_62        = -62,
    kALAC_ParamError_63        = -63,
    kALAC_ParamError_64        = -64,
    kALAC_ParamError_65        = -65,

    // Encoder error
    kALAC_ParamError_70        = -70,
    kALAC_ParamError_71        = -71,
    kALAC_ParamError_72        = -72,
    kALAC_ParamError_73        = -73,
    kALAC_ParamError_74        = -74,
    kALAC_ParamError_75        = -75,

    // Internal decoder error
    kALAC_ParamError_80        = -80,
    kALAC_ParamError_81        = -81,
    kALAC_ParamError_82        = -82,
    kALAC_ParamError_83        = -83,
    kALAC_ParamError_84        = -84,
    kALAC_ParamError_85        = -85,

    // Internal encoder error
    kALAC_ParamError_90        = -90,
    kALAC_ParamError_91        = -91,
    kALAC_ParamError_92        = -92,
    kALAC_ParamError_93        = -93,
    kALAC_ParamError_94        = -94,
    kALAC_ParamError_95        = -95,
...
enum
{
    kALACFormatAppleLossless = MAKE_ATOM('a','l','a','c'),
    kALACFormatLinearPCM = MAKE_ATOM('l','p','c','m')
};
...
enum
{
	kALACCodecFormat		= MAKE_ATOM('a','l','a','c'),
	kALACVersion			= 0,
...
enum
{
	AudioChannelLayoutAID = MAKE_ATOM('c','h','a','n')
};
